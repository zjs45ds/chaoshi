  ...
  <div class="home-page">
    ...
    <div class="content-container">
      ...
      <section class="playlist-section">
        ...
        <!-- 数据内容 -->
        <template v-else>
          <button class="slider-btn slider-btn-left" @click="prevPlaylistPage" v-show="playlistTotalPages > 1">
            <i class="left-icon"></i>
          </button>
          ...
          <button class="slider-btn slider-btn-right" @click="nextPlaylistPage" v-show="playlistTotalPages > 1">
      ...
      <section class="artist-section">
        ...
        <!-- 数据内容 -->
        <template v-else>
          <button class="slider-btn slider-btn-left" @click="prevArtistPage" v-show="artistTotalPages > 1">
            <i class="left-icon"></i>
          </button>
          ...
          <button class="slider-btn slider-btn-right" @click="nextArtistPage" v-show="artistTotalPages > 1">
            <i class="right-icon"></i>
          </button>
      ...
      <section class="album-section">
        ...
        <!-- 数据内容 -->
        <template v-else>
          <button class="slider-btn slider-btn-left" @click="prevAlbumPage" v-show="albumTotalPages > 1">
            <i class="left-icon"></i>
          </button>
          ...
          <button class="slider-btn slider-btn-right" @click="nextAlbumPage" v-show="albumTotalPages > 1">
            <i class="right-icon"></i>
          </button>
      ...
      <section class="song-section">
        ...
        <!-- 数据内容 -->
        <template v-else>
          <button class="slider-btn slider-btn-left" @click="prevSongPage" v-show="songTotalPages > 1">
            <i class="left-icon"></i>
          </button>
          ...
          <button class="slider-btn slider-btn-right" @click="nextSongPage" v-show="songTotalPages > 1">
            <i class="right-icon"></i>
          </button>
...
onMounted(async () => {
  ...
  artistCardsFullyVisible.value = true
  albumCardsFullyVisible.value = true
  songCardsFullyVisible.value = true
  
  // 仍保留原有检查逻辑，但增加延时确保DOM完全渲染
  setTimeout(() => {
    handleScroll()
  }, 300)
...
function triggerSlideAnimation(listSelector, direction, callback) {
  ...
  try {
    ...
    if (listElement) {
      ...
      listElement.style.transition = 'opacity 0.2s ease'
