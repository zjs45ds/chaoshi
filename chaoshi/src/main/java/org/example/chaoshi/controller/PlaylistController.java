...
public class PlaylistController {
    ...
    public ApiResult<Boolean> addSongToPlaylist(
        ...
        try {
            ...
            log.error("添加歌曲到歌单失败: playlistId={}, songId={}", id, songId, e);
    ...
    public ApiResult<Boolean> removeSongFromPlaylist(
        ...
        try {
            ...
            log.error("从歌单移除歌曲失败: playlistId={}, songId={}", id, songId, e);
    ...
    public ApiResult<Boolean> updateSongOrder(
        ...
        try {
            ...
            log.error("更新歌单歌曲排序失败: playlistId={}", id, e);
    ...
    public ApiResult<Boolean> clearPlaylist(
        ...
        try {
            ...
            log.error("清空歌单失败: playlistId={}", id, e);
